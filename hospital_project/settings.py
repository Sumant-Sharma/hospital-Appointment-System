...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-hospital-appointment-system-key-change-in-prod')
...
# Support environment DATABASE_URL if available (for PostgreSQL in production)
...
# Email Config (Console backend for dev notifications)
